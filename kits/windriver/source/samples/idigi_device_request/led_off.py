...
# ***************************************************************************
#
# Usage: led_off.py <username> <password> <device_id>
# -------------------------------------------------
import httplib
import base64
import sys
...
def Usage():
    print 'Usage: led_off.py <username> <password> <device_id>\n'
...
def PostMessage(username, password, device_id):
    ...
    message = """<sci_request version="1.0">
        <data_service>
            ...
            <requests>
            <device_request target_name="LED_OFF">My device request data</device_request>
            </requests>
        </data_service>
    </sci_request>
    """%(device_id)
