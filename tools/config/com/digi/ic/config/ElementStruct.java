...
public class ElementStruct {
    ...
    public ElementStruct(String nameStr, String descStr) throws Exception
    {

        if (descStr == null)
        {
            throw new Exception("Missing element description");
        }
    ...
    public void setType(String theType) throws Exception
    {
        if (type == null)
            type = theType;
        else throw new Exception("Duplicate <type> keyword: " + theType);
    }
    ...
    public void setAccess(String theAccess) throws Exception
    {
        if (access == null)
            access = theAccess;
         else throw new Exception("Duplicate <access> keyword: " + theAccess);
    }
    ...
    public void setMin(String theMin) throws Exception
    {
        if (min == null)
            min = theMin;
         else throw new Exception("Duplicate <min> keyword: " + theMin);
    }
        ...
        try {
            ...
            default:
                ...
                if (etype != ElementStruct.ElementType.INT32)
                {
                    ...
                    {
                        throw new Exception("Invalid min or max value for type: " + etype.toString().toLowerCase());
                    }
                    if ((minValue > UINT32_MAX_VALUE) || (maxValue > UINT32_MAX_VALUE))
                    {
                        throw new Exception("Overflow min or max value for type: " + etype.toString().toLowerCase());
                    }
                }
            ...
            if (etype != ElementType.ENUM && !valueMap.isEmpty())
            {
                throw new Exception("Invalid <value> for type: " + type);
            }
