...
#define IRL_MIN_NETWORK_TIMEOUT		1  /* in sec */
...
#define IRL_BUSY				-15
#define IRL_MALLOC_ERR			-16
#define IRL_INVALID_DATA		-17
#define IRL_DOWNLOAD_ERR		-18
#define IRL_SERVER_DISCONNECTED	-19
