 ...
 *
 * @note By default @ref IDIGI_DEBUG is defined in idigi_config.h, which will enable helpful debug
 * output from the IIK Library to be displayed.

 * @subsection good_results_output An example of successful IIK standard output
 * Below is the standard output shown for a successful run:
 *
 * @code
 *  >./idigi
 *  Start iDigi
