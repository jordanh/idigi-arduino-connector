...
${OBJECTDIR}/_ext/1598139559/ARP.o: /opt/microchip/Microchip/TCPIP\ Stack/ARP.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/_ext/1598139559/ARP.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PIC32MXSK=1 -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -D_LITTLE_ENDIAN -DIDIGI_DATA_SERVICE -I"../../../../public/include" -I"/opt/microchip/Microchip/Include" -I"." -MMD -MF "${OBJECTDIR}/_ext/1598139559/ARP.o.d" -o ${OBJECTDIR}/_ext/1598139559/ARP.o "/opt/microchip/Microchip/TCPIP Stack/ARP.c"  
...
${OBJECTDIR}/config.o: config.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/config.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PIC32MXSK=1 -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -D_LITTLE_ENDIAN -DIDIGI_DATA_SERVICE -I"../../../../public/include" -I"/opt/microchip/Microchip/Include" -I"." -MMD -MF "${OBJECTDIR}/config.o.d" -o ${OBJECTDIR}/config.o config.c  
	
${OBJECTDIR}/main.o: main.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/main.o.d 
	@${FIXDEPS} "${OBJECTDIR}/main.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PIC32MXSK=1 -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -D_LITTLE_ENDIAN -DIDIGI_DATA_SERVICE -I"../../../../public/include" -I"/opt/microchip/Microchip/Include" -I"." -MMD -MF "${OBJECTDIR}/main.o.d" -o ${OBJECTDIR}/main.o main.c  
	
${OBJECTDIR}/network.o: network.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/network.o.d 
	@${FIXDEPS} "${OBJECTDIR}/network.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PIC32MXSK=1 -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -D_LITTLE_ENDIAN -DIDIGI_DATA_SERVICE -I"../../../../public/include" -I"/opt/microchip/Microchip/Include" -I"." -MMD -MF "${OBJECTDIR}/network.o.d" -o ${OBJECTDIR}/network.o network.c  
	
${OBJECTDIR}/os.o: os.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/os.o.d 
	@${FIXDEPS} "${OBJECTDIR}/os.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PIC32MXSK=1 -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -D_LITTLE_ENDIAN -DIDIGI_DATA_SERVICE -I"../../../../public/include" -I"/opt/microchip/Microchip/Include" -I"." -MMD -MF "${OBJECTDIR}/os.o.d" -o ${OBJECTDIR}/os.o os.c  
	
else
${OBJECTDIR}/_ext/1598139559/ARP.o: /opt/microchip/Microchip/TCPIP\ Stack/ARP.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/1598139559 
	@${RM} ${OBJECTDIR}/_ext/1598139559/ARP.o.d 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1598139559/ARP.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -D_LITTLE_ENDIAN -DIDIGI_DATA_SERVICE -I"../../../../public/include" -I"/opt/microchip/Microchip/Include" -I"." -MMD -MF "${OBJECTDIR}/_ext/1598139559/ARP.o.d" -o ${OBJECTDIR}/_ext/1598139559/ARP.o "/opt/microchip/Microchip/TCPIP Stack/ARP.c"  
...
${OBJECTDIR}/config.o: config.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/config.o.d 
	@${FIXDEPS} "${OBJECTDIR}/config.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -D_LITTLE_ENDIAN -DIDIGI_DATA_SERVICE -I"../../../../public/include" -I"/opt/microchip/Microchip/Include" -I"." -MMD -MF "${OBJECTDIR}/config.o.d" -o ${OBJECTDIR}/config.o config.c  
	
${OBJECTDIR}/main.o: main.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/main.o.d 
	@${FIXDEPS} "${OBJECTDIR}/main.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -D_LITTLE_ENDIAN -DIDIGI_DATA_SERVICE -I"../../../../public/include" -I"/opt/microchip/Microchip/Include" -I"." -MMD -MF "${OBJECTDIR}/main.o.d" -o ${OBJECTDIR}/main.o main.c  
	
${OBJECTDIR}/network.o: network.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/network.o.d 
	@${FIXDEPS} "${OBJECTDIR}/network.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -D_LITTLE_ENDIAN -DIDIGI_DATA_SERVICE -I"../../../../public/include" -I"/opt/microchip/Microchip/Include" -I"." -MMD -MF "${OBJECTDIR}/network.o.d" -o ${OBJECTDIR}/network.o network.c  
	
${OBJECTDIR}/os.o: os.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/os.o.d 
	@${FIXDEPS} "${OBJECTDIR}/os.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -D_LITTLE_ENDIAN -DIDIGI_DATA_SERVICE -I"../../../../public/include" -I"/opt/microchip/Microchip/Include" -I"." -MMD -MF "${OBJECTDIR}/os.o.d" -o ${OBJECTDIR}/os.o os.c  
...
dist/${CND_CONF}/${IMAGE_TYPE}/ethstarterkit32.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mdebugger -D__MPLAB_DEBUGGER_PIC32MXSK=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/ethstarterkit32.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}        -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__ICD2RAM=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PIC32MXSK=1,--defsym=_min_heap_size=44000,--defsym=_min_stack_size=4096 
else
dist/${CND_CONF}/${IMAGE_TYPE}/ethstarterkit32.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/ethstarterkit32.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}        -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=_min_heap_size=44000,--defsym=_min_stack_size=4096
