 ...
 * This file was generated on: 2012/06/13 10:43:55 
 * The command line arguments were: "-server=test.idigi.com mlchan:***** "Linux Application" 1 xhex.rci"
...
typedef struct {
 ...
 typedef struct {    idigi_element_value_unsigned_integer_t unsigned_integer_value;
...
#define IDIGI_RCI_ERROR_PARSER_ERROR (idigi_remote_all_strings+146)
#define IDIGI_RCI_ERROR_BAD_XML (idigi_remote_all_strings+159)
#define IDIGI_RCI_ERROR_BAD_COMMAND (idigi_remote_all_strings+167)
#define IDIGI_RCI_ERROR_INVALID_VERSION (idigi_remote_all_strings+179)
#define IDIGI_RCI_ERROR_BAD_GROUP (idigi_remote_all_strings+195)
#define IDIGI_RCI_ERROR_BAD_INDEX (idigi_remote_all_strings+205)
#define IDIGI_RCI_ERROR_BAD_ELEMENT (idigi_remote_all_strings+215)
#define IDIGI_RCI_ERROR_BAD_VALUE (idigi_remote_all_strings+227)
