...
def test_set_setting_and_state():
    tests = [
            ...
            TestCase('<set_state><gps_stats/></set_state>','Bad element','set_state_no_element_1'),
            TestCase('<set_setting><system></system></set_setting>','Bad element','set_setting_no_element_2'),
            TestCase('<set_state><gps_stats></gps_stats></set_state>','Bad element','set_state_no_element_2'),
