 ...
 * This file was generated on: 2012/06/21 15:58:56 
...
#define STATE_GPS_STATS (idigi_remote_all_strings+182)
#define STATE_GPS_STATS_LATITUDE (idigi_remote_all_strings+192)
#define STATE_GPS_STATS_LONGITUDE (idigi_remote_all_strings+201)
#define IDIGI_GLOBAL_ERROR_LOAD_FAIL (idigi_remote_all_strings+211)
#define IDIGI_GLOBAL_ERROR_SAVE_FAIL (idigi_remote_all_strings+221)
#define IDIGI_GLOBAL_ERROR_MEMORY_FAIL (idigi_remote_all_strings+231)
#define IDIGI_RCI_ERROR_PARSER_ERROR (idigi_remote_all_strings+251)
#define IDIGI_RCI_ERROR_BAD_XML (idigi_remote_all_strings+264)
#define IDIGI_RCI_ERROR_BAD_COMMAND (idigi_remote_all_strings+272)
#define IDIGI_RCI_ERROR_INVALID_VERSION (idigi_remote_all_strings+284)
#define IDIGI_RCI_ERROR_BAD_GROUP (idigi_remote_all_strings+300)
#define IDIGI_RCI_ERROR_BAD_INDEX (idigi_remote_all_strings+310)
#define IDIGI_RCI_ERROR_BAD_ELEMENT (idigi_remote_all_strings+320)
#define IDIGI_RCI_ERROR_BAD_VALUE (idigi_remote_all_strings+332)
