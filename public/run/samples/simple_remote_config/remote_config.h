 ...
 * This file was generated on: 2012/05/21 11:12:18 
...
#define SETTING_SYSTEM (idigi_remote_all_strings+122)
#define SETTING_SYSTEM_CONTACT (idigi_remote_all_strings+129)
#define SETTING_SYSTEM_LOCATION (idigi_remote_all_strings+137)
#define SETTING_SYSTEM_DESCRIPTION (idigi_remote_all_strings+146)
#define SETTING_SYSTEM_ERROR_INVALID_LENGTH (idigi_remote_all_strings+158)
#define SETTING_SYSTEM_ERROR_NO_MEMORY (idigi_remote_all_strings+173)
#define IDIGI_RCI_ERROR_PARSER_ERROR (idigi_remote_all_strings+183)
#define IDIGI_RCI_ERROR_BAD_XML (idigi_remote_all_strings+196)
#define IDIGI_RCI_ERROR_BAD_COMMAND (idigi_remote_all_strings+204)
#define IDIGI_RCI_ERROR_INVALID_VERSION (idigi_remote_all_strings+216)
#define IDIGI_RCI_ERROR_BAD_GROUP (idigi_remote_all_strings+232)
#define IDIGI_RCI_ERROR_BAD_INDEX (idigi_remote_all_strings+242)
#define IDIGI_RCI_ERROR_BAD_ELEMENT (idigi_remote_all_strings+252)
#define IDIGI_RCI_ERROR_BAD_VALUE (idigi_remote_all_strings+264)
