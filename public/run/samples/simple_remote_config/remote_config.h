 ...
 * This file was generated on: 2012/06/04 11:04:36 
...
#define SETTING_SYSTEM (idigi_remote_all_strings+126)
#define SETTING_SYSTEM_CONTACT (idigi_remote_all_strings+133)
#define SETTING_SYSTEM_LOCATION (idigi_remote_all_strings+141)
#define SETTING_SYSTEM_DESCRIPTION (idigi_remote_all_strings+150)
#define SETTING_SYSTEM_ERROR_INVALID_LENGTH (idigi_remote_all_strings+162)
#define SETTING_SYSTEM_ERROR_NO_MEMORY (idigi_remote_all_strings+177)
#define IDIGI_RCI_ERROR_PARSER_ERROR (idigi_remote_all_strings+187)
#define IDIGI_RCI_ERROR_BAD_XML (idigi_remote_all_strings+200)
#define IDIGI_RCI_ERROR_BAD_COMMAND (idigi_remote_all_strings+208)
#define IDIGI_RCI_ERROR_INVALID_VERSION (idigi_remote_all_strings+220)
#define IDIGI_RCI_ERROR_BAD_GROUP (idigi_remote_all_strings+236)
#define IDIGI_RCI_ERROR_BAD_INDEX (idigi_remote_all_strings+246)
#define IDIGI_RCI_ERROR_BAD_ELEMENT (idigi_remote_all_strings+256)
#define IDIGI_RCI_ERROR_BAD_VALUE (idigi_remote_all_strings+268)
