 ...
 * This file was generated on: 2012/04/26 15:54:34 
...
#define IDIGI_RCI_ERROR_PARSER_ERROR (idigi_remote_all_strings+156)
#define IDIGI_RCI_ERROR_BAD_XML (idigi_remote_all_strings+169)
#define IDIGI_RCI_ERROR_BAD_COMMAND (idigi_remote_all_strings+177)
#define IDIGI_RCI_ERROR_INVALID_VERSION (idigi_remote_all_strings+189)
#define IDIGI_RCI_ERROR_BAD_GROUP (idigi_remote_all_strings+205)
#define IDIGI_RCI_ERROR_BAD_INDEX (idigi_remote_all_strings+215)
#define IDIGI_RCI_ERROR_BAD_ELEMENT (idigi_remote_all_strings+225)
#define IDIGI_RCI_ERROR_BAD_VALUE (idigi_remote_all_strings+237)
#define IDIGI_GLOBAL_ERROR_LOAD_FAIL (idigi_remote_all_strings+247)
#define IDIGI_GLOBAL_ERROR_SAVE_FAIL (idigi_remote_all_strings+272)
#define IDIGI_GLOBAL_ERROR_NO_MEMORY (idigi_remote_all_strings+297)
