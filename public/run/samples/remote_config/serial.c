...
idigi_callback_status_t app_serial_group_init(idigi_remote_group_request_t * request, idigi_remote_group_response_t * response)
{
    ...
    if (app_os_malloc(sizeof *serial_ptr, &ptr) != 0)
    {
        ...
        response->element_data.error_hint = SERIAL_NO_MEMORY_HINT;
        goto done;
    }
...
idigi_callback_status_t app_serial_group_get(idigi_remote_group_request_t * request, idigi_remote_group_response_t * response)
{
    ...
    case idigi_group_serial_baud:
        ...
        {
        case 2400:
            response->element_data.element_value->enum_value = idigi_group_serial_baud_2400;
            break;
        case 4800:
            response->element_data.element_value->enum_value = idigi_group_serial_baud_4800;
            break;
        case 9600:
            response->element_data.element_value->enum_value = idigi_group_serial_baud_9600;
            break;
        case 19200:
            response->element_data.element_value->enum_value = idigi_group_serial_baud_19200;
            break;
        case 38400:
            response->element_data.element_value->enum_value = idigi_group_serial_baud_38400;
            break;
        case 57600:
            response->element_data.element_value->enum_value = idigi_group_serial_baud_57600;
            break;
        case 115200:
            response->element_data.element_value->enum_value = idigi_group_serial_baud_115200;
            break;
        case 230400:
            response->element_data.element_value->enum_value = idigi_group_serial_baud_230400;
            break;
        default:
            response->error_id = idigi_group_serial_error_invalid_baud;
    ...
    case idigi_group_serial_parity:
        ...
        {
        case parity_none:
            response->element_data.element_value->enum_value = idigi_group_serial_parity_none;
            break;
        case parity_odd:
            response->element_data.element_value->enum_value = idigi_group_serial_parity_odd;
            break;
        case parity_even:
            response->element_data.element_value->enum_value = idigi_group_serial_parity_even;
            break;
        default:
            response->error_id = idigi_group_serial_error_invalid_parity;
            response->element_data.error_hint = SERIAL_INVALID_STORED_VALUE_HINT;
            break;
        }
        break;
    ...
    case idigi_group_serial_xbreak:
        ...
        break;
    case idigi_group_serial_txbytes:
...
idigi_callback_status_t app_serial_group_set(idigi_remote_group_request_t * request, idigi_remote_group_response_t * response)
{
    idigi_callback_status_t status = idigi_callback_continue;
    ...
    case idigi_group_serial_baud:
    {
        ...
        {
        case idigi_group_serial_baud_2400:
        case idigi_group_serial_baud_4800:
        case idigi_group_serial_baud_9600:
        case idigi_group_serial_baud_19200:
        case idigi_group_serial_baud_38400:
        case idigi_group_serial_baud_57600:
        case idigi_group_serial_baud_115200:
        case idigi_group_serial_baud_230400:
    ...
    case idigi_group_serial_parity:
    {
        ...
        switch (request->element_value->enum_value)
        {
        case idigi_group_serial_parity_none:
        case idigi_group_serial_parity_odd:
        case idigi_group_serial_parity_even:
            ASSERT(request->element_type == idigi_element_type_enum);
