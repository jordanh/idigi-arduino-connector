 ...
 * This file was generated on: 2012/05/08 17:30:06 
...
#define SETTING_SYSTEM (idigi_remote_all_strings+552)
#define SETTING_SYSTEM_CONTACT (idigi_remote_all_strings+559)
#define SETTING_SYSTEM_LOCATION (idigi_remote_all_strings+567)
#define SETTING_SYSTEM_DESCRIPTION (idigi_remote_all_strings+576)
#define SETTING_SYSTEM_ERROR_INVALID_LENGTH (idigi_remote_all_strings+588)
#define SETTING_DEVICESECURITY (idigi_remote_all_strings+603)
#define SETTING_DEVICESECURITY_IDENTITYVERIFICATIONFORM (idigi_remote_all_strings+618)
#define SETTING_DEVICESECURITY_IDENTITYVERIFICATIONFORM_SIMPLE (idigi_remote_all_strings+643)
#define SETTING_DEVICESECURITY_IDENTITYVERIFICATIONFORM_PASSWORD (idigi_remote_all_strings+650)
#define SETTING_DEVICESECURITY_PASSWORD (idigi_remote_all_strings+659)
#define STATE_DEBUG_INFO (idigi_remote_all_strings+668)
#define STATE_DEBUG_INFO_VERSION (idigi_remote_all_strings+679)
#define STATE_DEBUG_INFO_STACKTOP (idigi_remote_all_strings+687)
#define STATE_DEBUG_INFO_STACKSIZE (idigi_remote_all_strings+696)
#define STATE_DEBUG_INFO_STACKBOTTOM (idigi_remote_all_strings+706)
#define STATE_DEBUG_INFO_USEDMEM (idigi_remote_all_strings+718)
#define STATE_GPS_STATS (idigi_remote_all_strings+726)
#define STATE_GPS_STATS_LATITUDE (idigi_remote_all_strings+736)
#define STATE_GPS_STATS_LONGITUDE (idigi_remote_all_strings+745)
#define STATE_GPS_STATS_ERROR_INVALID_LAT (idigi_remote_all_strings+755)
#define STATE_GPS_STATS_ERROR_INVALID_LONG (idigi_remote_all_strings+767)
#define IDIGI_RCI_ERROR_PARSER_ERROR (idigi_remote_all_strings+780)
#define IDIGI_RCI_ERROR_BAD_XML (idigi_remote_all_strings+793)
#define IDIGI_RCI_ERROR_BAD_COMMAND (idigi_remote_all_strings+801)
#define IDIGI_RCI_ERROR_INVALID_VERSION (idigi_remote_all_strings+813)
#define IDIGI_RCI_ERROR_BAD_GROUP (idigi_remote_all_strings+829)
#define IDIGI_RCI_ERROR_BAD_INDEX (idigi_remote_all_strings+839)
#define IDIGI_RCI_ERROR_BAD_ELEMENT (idigi_remote_all_strings+849)
#define IDIGI_RCI_ERROR_BAD_VALUE (idigi_remote_all_strings+861)
#define IDIGI_GLOBAL_ERROR_LOAD_FAIL (idigi_remote_all_strings+871)
#define IDIGI_GLOBAL_ERROR_SAVE_FAIL (idigi_remote_all_strings+881)
#define IDIGI_GLOBAL_ERROR_MEMORY_FAIL (idigi_remote_all_strings+891)
