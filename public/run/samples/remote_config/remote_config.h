 ...
 * This file was generated on: 2012/05/17 18:24:12 
...
#define STATE_GPS_STATS (idigi_remote_all_strings+718)
#define STATE_GPS_STATS_LATITUDE (idigi_remote_all_strings+728)
#define STATE_GPS_STATS_LONGITUDE (idigi_remote_all_strings+737)
#define STATE_GPS_STATS_ERROR_INVALID_LAT (idigi_remote_all_strings+747)
#define STATE_GPS_STATS_ERROR_INVALID_LONG (idigi_remote_all_strings+759)
#define IDIGI_RCI_ERROR_PARSER_ERROR (idigi_remote_all_strings+772)
#define IDIGI_RCI_ERROR_BAD_XML (idigi_remote_all_strings+785)
#define IDIGI_RCI_ERROR_BAD_COMMAND (idigi_remote_all_strings+793)
#define IDIGI_RCI_ERROR_INVALID_VERSION (idigi_remote_all_strings+805)
#define IDIGI_RCI_ERROR_BAD_GROUP (idigi_remote_all_strings+821)
#define IDIGI_RCI_ERROR_BAD_INDEX (idigi_remote_all_strings+831)
#define IDIGI_RCI_ERROR_BAD_ELEMENT (idigi_remote_all_strings+841)
#define IDIGI_RCI_ERROR_BAD_VALUE (idigi_remote_all_strings+853)
#define IDIGI_GLOBAL_ERROR_LOAD_FAIL (idigi_remote_all_strings+863)
#define IDIGI_GLOBAL_ERROR_SAVE_FAIL (idigi_remote_all_strings+873)
#define IDIGI_GLOBAL_ERROR_MEMORY_FAIL (idigi_remote_all_strings+883)
