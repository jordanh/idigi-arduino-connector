 ...
 * This file was generated on: 2012/06/19 16:16:43 
...
typedef enum {
 idigi_setting_device_stats_error_invalid_time = idigi_global_error_COUNT,
 idigi_setting_device_stats_error_invalid_integer,
 idigi_setting_device_stats_error_COUNT
} idigi_setting_device_stats_error_id_t;
...
#define SETTING_DEVICE_STATS_ERROR_INVALID_TIME (idigi_remote_all_strings+582)
#define SETTING_DEVICE_STATS_ERROR_INVALID_INTEGER (idigi_remote_all_strings+595)
#define SETTING_DEVICE_INFO (idigi_remote_all_strings+617)
#define SETTING_DEVICE_INFO_PRODUCT (idigi_remote_all_strings+629)
#define SETTING_DEVICE_INFO_MODEL (idigi_remote_all_strings+637)
#define SETTING_DEVICE_INFO_COMPANY (idigi_remote_all_strings+643)
#define SETTING_DEVICE_INFO_DESC (idigi_remote_all_strings+651)
#define SETTING_DEVICE_INFO_SYSPWD (idigi_remote_all_strings+656)
...
#define STATE_DEBUG_INFO (idigi_remote_all_strings+794)
#define STATE_DEBUG_INFO_VERSION (idigi_remote_all_strings+805)
#define STATE_DEBUG_INFO_STACKSIZE (idigi_remote_all_strings+813)
#define STATE_GPS_STATS (idigi_remote_all_strings+823)
#define STATE_GPS_STATS_LATITUDE (idigi_remote_all_strings+833)
#define STATE_GPS_STATS_LONGITUDE (idigi_remote_all_strings+842)
#define STATE_GPS_STATS_ERROR_INVALID_LAT (idigi_remote_all_strings+852)
#define STATE_GPS_STATS_ERROR_INVALID_LONG (idigi_remote_all_strings+875)
#define IDIGI_GLOBAL_ERROR_LOAD_FAIL (idigi_remote_all_strings+899)
#define IDIGI_GLOBAL_ERROR_SAVE_FAIL (idigi_remote_all_strings+909)
#define IDIGI_GLOBAL_ERROR_MEMORY_FAIL (idigi_remote_all_strings+919)
#define IDIGI_RCI_ERROR_PARSER_ERROR (idigi_remote_all_strings+939)
#define IDIGI_RCI_ERROR_BAD_XML (idigi_remote_all_strings+952)
#define IDIGI_RCI_ERROR_BAD_COMMAND (idigi_remote_all_strings+960)
#define IDIGI_RCI_ERROR_INVALID_VERSION (idigi_remote_all_strings+972)
#define IDIGI_RCI_ERROR_BAD_GROUP (idigi_remote_all_strings+988)
#define IDIGI_RCI_ERROR_BAD_INDEX (idigi_remote_all_strings+998)
#define IDIGI_RCI_ERROR_BAD_ELEMENT (idigi_remote_all_strings+1008)
#define IDIGI_RCI_ERROR_BAD_VALUE (idigi_remote_all_strings+1020)
...
static char const * const setting_device_stats_errors[] = {
 SETTING_DEVICE_STATS_ERROR_INVALID_TIME, /*invalid_time*/
 SETTING_DEVICE_STATS_ERROR_INVALID_INTEGER /*invalid_integer*/
};
