 ...
 * This file was generated on: 2012/06/15 17:33:24 
...
#define SETTING_SYSTEM (idigi_remote_all_strings+643)
#define SETTING_SYSTEM_DESCRIPTION (idigi_remote_all_strings+650)
#define SETTING_SYSTEM_CONTACT (idigi_remote_all_strings+662)
#define SETTING_SYSTEM_LOCATION (idigi_remote_all_strings+670)
#define SETTING_SYSTEM_ERROR_INVALID_LENGTH (idigi_remote_all_strings+679)
#define SETTING_DEVICESECURITY (idigi_remote_all_strings+694)
#define SETTING_DEVICESECURITY_IDENTITYVERIFICATIONFORM (idigi_remote_all_strings+709)
#define SETTING_DEVICESECURITY_IDENTITYVERIFICATIONFORM_SIMPLE (idigi_remote_all_strings+734)
#define SETTING_DEVICESECURITY_IDENTITYVERIFICATIONFORM_PASSWORD (idigi_remote_all_strings+741)
#define SETTING_DEVICESECURITY_PASSWORD (idigi_remote_all_strings+750)
#define STATE_DEBUG_INFO (idigi_remote_all_strings+759)
#define STATE_DEBUG_INFO_VERSION (idigi_remote_all_strings+770)
#define STATE_DEBUG_INFO_STACKSIZE (idigi_remote_all_strings+778)
#define STATE_GPS_STATS (idigi_remote_all_strings+788)
#define STATE_GPS_STATS_LATITUDE (idigi_remote_all_strings+798)
#define STATE_GPS_STATS_LONGITUDE (idigi_remote_all_strings+807)
#define STATE_GPS_STATS_ERROR_INVALID_LAT (idigi_remote_all_strings+817)
#define STATE_GPS_STATS_ERROR_INVALID_LONG (idigi_remote_all_strings+840)
#define IDIGI_GLOBAL_ERROR_LOAD_FAIL (idigi_remote_all_strings+864)
#define IDIGI_GLOBAL_ERROR_SAVE_FAIL (idigi_remote_all_strings+874)
#define IDIGI_GLOBAL_ERROR_MEMORY_FAIL (idigi_remote_all_strings+884)
#define IDIGI_RCI_ERROR_PARSER_ERROR (idigi_remote_all_strings+904)
#define IDIGI_RCI_ERROR_BAD_XML (idigi_remote_all_strings+917)
#define IDIGI_RCI_ERROR_BAD_COMMAND (idigi_remote_all_strings+925)
#define IDIGI_RCI_ERROR_INVALID_VERSION (idigi_remote_all_strings+937)
#define IDIGI_RCI_ERROR_BAD_GROUP (idigi_remote_all_strings+953)
#define IDIGI_RCI_ERROR_BAD_INDEX (idigi_remote_all_strings+963)
#define IDIGI_RCI_ERROR_BAD_ELEMENT (idigi_remote_all_strings+973)
#define IDIGI_RCI_ERROR_BAD_VALUE (idigi_remote_all_strings+985)
