 ...
 * This file was generated on: 2012/06/21 16:33:22 
 * The command line arguments were: "-verbose -server=test.idigi.com mlchan:***** "Linux Application" 1.0.0.0 config.rci"
...
#define SETTING_DEVICE_INFO_PRODUCT (idigi_remote_all_strings+628)
#define SETTING_DEVICE_INFO_MODEL (idigi_remote_all_strings+636)
#define SETTING_DEVICE_INFO_COMPANY (idigi_remote_all_strings+642)
#define SETTING_DEVICE_INFO_DESC (idigi_remote_all_strings+650)
#define SETTING_DEVICE_INFO_SYSPWD (idigi_remote_all_strings+655)
#define SETTING_DEVICE_INFO_ERROR_INVALID_LENGTH (idigi_remote_all_strings+662)
#define SETTING_SYSTEM (idigi_remote_all_strings+677)
#define SETTING_SYSTEM_DESCRIPTION (idigi_remote_all_strings+684)
#define SETTING_SYSTEM_CONTACT (idigi_remote_all_strings+696)
#define SETTING_SYSTEM_LOCATION (idigi_remote_all_strings+704)
#define SETTING_SYSTEM_ERROR_INVALID_LENGTH (idigi_remote_all_strings+713)
#define SETTING_DEVICESECURITY (idigi_remote_all_strings+728)
#define SETTING_DEVICESECURITY_IDENTITYVERIFICATIONFORM (idigi_remote_all_strings+743)
#define SETTING_DEVICESECURITY_IDENTITYVERIFICATIONFORM_SIMPLE (idigi_remote_all_strings+768)
#define SETTING_DEVICESECURITY_IDENTITYVERIFICATIONFORM_PASSWORD (idigi_remote_all_strings+775)
#define SETTING_DEVICESECURITY_PASSWORD (idigi_remote_all_strings+784)
#define STATE_GPS_STATS (idigi_remote_all_strings+793)
#define STATE_GPS_STATS_LATITUDE (idigi_remote_all_strings+803)
#define STATE_GPS_STATS_LONGITUDE (idigi_remote_all_strings+812)
#define STATE_DEBUG_INFO (idigi_remote_all_strings+822)
#define STATE_DEBUG_INFO_VERSION (idigi_remote_all_strings+833)
#define STATE_DEBUG_INFO_STACKSIZE (idigi_remote_all_strings+841)
