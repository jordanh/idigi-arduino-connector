...
typedef enum {
 idigi_setting_serial_error_invalid_baud = idigi_rci_error_COUNT,
...
typedef enum {
 idigi_setting_ethernet_error_invalid_duplex = idigi_rci_error_COUNT,
...
typedef enum {
 idigi_setting_device_info_error_invalid_length = idigi_rci_error_COUNT,
