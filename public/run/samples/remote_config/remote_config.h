...
typedef enum {
 idigi_setting_gps_state,
 idigi_setting_gps_latitude,
 idigi_setting_gps_longitude,
 idigi_setting_gps_COUNT
} idigi_setting_gps_id_t;

typedef enum {
 idigi_setting_gps_error_invalid_lat = idigi_global_error_COUNT,
 idigi_setting_gps_error_invalid_long,
 idigi_setting_gps_error_COUNT
} idigi_setting_gps_error_id_t;
