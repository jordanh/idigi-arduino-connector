 ...
 * This file was generated on: 2012/07/10 15:46:00 
...
typedef enum {
 idigi_state_device_state_system_up_time,
 idigi_state_device_state_signed_integer,
 idigi_state_device_state_COUNT
} idigi_state_device_state_id_t;

typedef enum {
 idigi_state_device_state_error_invalid_integer = idigi_global_error_COUNT,
 idigi_state_device_state_error_COUNT
} idigi_state_device_state_error_id_t;
...
#define SETTING_DEVICE_TIME_ERROR_INVALID_TIME (idigi_remote_all_strings+566)
#define SETTING_DEVICE_INFO (idigi_remote_all_strings+579)
#define SETTING_DEVICE_INFO_VERSION (idigi_remote_all_strings+591)
#define SETTING_DEVICE_INFO_PRODUCT (idigi_remote_all_strings+599)
#define SETTING_DEVICE_INFO_MODEL (idigi_remote_all_strings+607)
#define SETTING_DEVICE_INFO_COMPANY (idigi_remote_all_strings+613)
#define SETTING_DEVICE_INFO_DESC (idigi_remote_all_strings+621)
#define SETTING_DEVICE_INFO_ERROR_INVALID_LENGTH (idigi_remote_all_strings+626)
#define SETTING_SYSTEM (idigi_remote_all_strings+641)
#define SETTING_SYSTEM_DESCRIPTION (idigi_remote_all_strings+648)
#define SETTING_SYSTEM_CONTACT (idigi_remote_all_strings+660)
#define SETTING_SYSTEM_LOCATION (idigi_remote_all_strings+668)
#define SETTING_SYSTEM_ERROR_INVALID_LENGTH (idigi_remote_all_strings+677)
#define SETTING_DEVICESECURITY (idigi_remote_all_strings+692)
#define SETTING_DEVICESECURITY_IDENTITYVERIFICATIONFORM (idigi_remote_all_strings+707)
#define SETTING_DEVICESECURITY_IDENTITYVERIFICATIONFORM_SIMPLE (idigi_remote_all_strings+732)
#define SETTING_DEVICESECURITY_IDENTITYVERIFICATIONFORM_PASSWORD (idigi_remote_all_strings+739)
#define SETTING_DEVICESECURITY_PASSWORD (idigi_remote_all_strings+748)
#define STATE_DEVICE_STATE (idigi_remote_all_strings+757)
#define STATE_DEVICE_STATE_SYSTEM_UP_TIME (idigi_remote_all_strings+770)
#define STATE_DEVICE_STATE_SIGNED_INTEGER (idigi_remote_all_strings+785)
#define STATE_DEVICE_STATE_ERROR_INVALID_INTEGER (idigi_remote_all_strings+800)
#define STATE_GPS_STATS (idigi_remote_all_strings+822)
#define STATE_GPS_STATS_LATITUDE (idigi_remote_all_strings+832)
#define STATE_GPS_STATS_LONGITUDE (idigi_remote_all_strings+841)
#define IDIGI_GLOBAL_ERROR_LOAD_FAIL (idigi_remote_all_strings+851)
#define IDIGI_GLOBAL_ERROR_SAVE_FAIL (idigi_remote_all_strings+861)
#define IDIGI_GLOBAL_ERROR_MEMORY_FAIL (idigi_remote_all_strings+871)
#define IDIGI_RCI_ERROR_PARSER_ERROR (idigi_remote_all_strings+891)
#define IDIGI_RCI_ERROR_BAD_XML (idigi_remote_all_strings+904)
#define IDIGI_RCI_ERROR_BAD_COMMAND (idigi_remote_all_strings+912)
#define IDIGI_RCI_ERROR_INVALID_VERSION (idigi_remote_all_strings+924)
#define IDIGI_RCI_ERROR_BAD_GROUP (idigi_remote_all_strings+940)
#define IDIGI_RCI_ERROR_BAD_INDEX (idigi_remote_all_strings+950)
#define IDIGI_RCI_ERROR_BAD_ELEMENT (idigi_remote_all_strings+960)
#define IDIGI_RCI_ERROR_BAD_VALUE (idigi_remote_all_strings+972)
...
char const idigi_remote_all_strings[] = {
 ...
 8,'p','a','s','s','w','o','r','d',
 8,'p','a','s','s','w','o','r','d',
 12,'d','e','v','i','c','e','_','s','t','a','t','e',
 14,'s','y','s','t','e','m','_','u','p','_','t','i','m','e',
...
static idigi_element_value_signed_integer_t const state_device_state_signed_integer_limit = {
 -100,
 100
};

static idigi_group_element_t const state_device_state_elements[] = {
 { STATE_DEVICE_STATE_SYSTEM_UP_TIME,  /*system_up_time*/
   idigi_element_access_read_only,
   idigi_element_type_uint32,
  NULL
 },
 { STATE_DEVICE_STATE_SIGNED_INTEGER,  /*signed_integer*/
   idigi_element_access_read_write,
   idigi_element_type_int32,
  (idigi_element_value_limit_t *)&state_device_state_signed_integer_limit
 }
};
...
static idigi_group_t const idigi_state_groups[] = {
 { STATE_DEVICE_STATE,  /*device_state*/
   1,
