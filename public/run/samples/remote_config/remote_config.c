 ...
 * This file was generated on: 2012/04/17 11:16:15 
 * The command line arguments were: "-nodesc -s=test.idigi.com mlchan:***** "Linux Application" 1 config.rci" 
...
#define SETTING_ETHERNET    (idigi_remote_all_strings + 212)
#define SETTING_ETHERNET_IP    (idigi_remote_all_strings + 221)
#define SETTING_ETHERNET_SUBNET    (idigi_remote_all_strings + 224)
#define SETTING_ETHERNET_GATEWAY    (idigi_remote_all_strings + 231)
#define SETTING_ETHERNET_DHCP    (idigi_remote_all_strings + 239)
#define SETTING_ETHERNET_DNS    (idigi_remote_all_strings + 244)
#define SETTING_ETHERNET_DUPLEX    (idigi_remote_all_strings + 248)
#define SETTING_ETHERNET_DUPLEX_AUTO    (idigi_remote_all_strings + 255)
#define SETTING_ETHERNET_DUPLEX_HALF    (idigi_remote_all_strings + 260)
#define SETTING_ETHERNET_DUPLEX_FULL    (idigi_remote_all_strings + 265)
#define SETTING_DEVICE_STATS    (idigi_remote_all_strings + 270)
#define SETTING_DEVICE_STATS_CURTIME    (idigi_remote_all_strings + 283)
#define SETTING_DEVICE_STATS_CTEMP    (idigi_remote_all_strings + 291)
#define SETTING_DEVICE_STATS_FTEMP    (idigi_remote_all_strings + 297)
#define SETTING_DEVICE_INFO    (idigi_remote_all_strings + 303)
#define SETTING_DEVICE_INFO_PRODUCT    (idigi_remote_all_strings + 315)
#define SETTING_DEVICE_INFO_MODEL    (idigi_remote_all_strings + 323)
#define SETTING_DEVICE_INFO_COMPANY    (idigi_remote_all_strings + 329)
#define SETTING_DEVICE_INFO_DESC    (idigi_remote_all_strings + 337)
#define SETTING_DEVICE_INFO_SYSPWD    (idigi_remote_all_strings + 342)
#define STATE_DEBUG_INFO    (idigi_remote_all_strings + 349)
#define STATE_DEBUG_INFO_VERSION    (idigi_remote_all_strings + 360)
#define STATE_DEBUG_INFO_STACKTOP    (idigi_remote_all_strings + 368)
#define STATE_DEBUG_INFO_STACKSIZE    (idigi_remote_all_strings + 377)
#define STATE_DEBUG_INFO_STACKBOTTOM    (idigi_remote_all_strings + 387)
#define STATE_DEBUG_INFO_USEDMEM    (idigi_remote_all_strings + 399)
