 ...
 * This file was generated on: 2012/04/12 16:55:22 
...
#define SETTING_SERIAL    (idigi_remote_all_strings + 108)
#define SETTING_SERIAL_BAUD    (idigi_remote_all_strings + 115)
#define SETTING_SERIAL_BAUD_2400    (idigi_remote_all_strings + 120)
#define SETTING_SERIAL_BAUD_4800    (idigi_remote_all_strings + 125)
#define SETTING_SERIAL_BAUD_9600    (idigi_remote_all_strings + 130)
#define SETTING_SERIAL_BAUD_19200    (idigi_remote_all_strings + 135)
#define SETTING_SERIAL_BAUD_38400    (idigi_remote_all_strings + 141)
#define SETTING_SERIAL_BAUD_57600    (idigi_remote_all_strings + 147)
#define SETTING_SERIAL_BAUD_115200    (idigi_remote_all_strings + 153)
#define SETTING_SERIAL_BAUD_230400    (idigi_remote_all_strings + 160)
#define SETTING_SERIAL_PARITY    (idigi_remote_all_strings + 167)
#define SETTING_SERIAL_PARITY_NONE    (idigi_remote_all_strings + 174)
#define SETTING_SERIAL_PARITY_ODD    (idigi_remote_all_strings + 179)
#define SETTING_SERIAL_PARITY_EVEN    (idigi_remote_all_strings + 183)
#define SETTING_SERIAL_DATABITS    (idigi_remote_all_strings + 188)
#define SETTING_SERIAL_XBREAK    (idigi_remote_all_strings + 197)
#define SETTING_SERIAL_TXBYTES    (idigi_remote_all_strings + 204)
#define SETTING_SERIAL_ERROR_INVALID_BAUD    (idigi_remote_all_strings + 212)
#define SETTING_SERIAL_ERROR_INVALID_DATABITS    (idigi_remote_all_strings + 225)
#define SETTING_SERIAL_ERROR_INVALID_PARITY    (idigi_remote_all_strings + 242)
#define SETTING_SERIAL_ERROR_INVALID_XBREAK    (idigi_remote_all_strings + 257)
#define SETTING_SERIAL_ERROR_INVALID_DATABITS_PARITY    (idigi_remote_all_strings + 272)
#define SETTING_ETHERNET    (idigi_remote_all_strings + 296)
#define SETTING_ETHERNET_IP    (idigi_remote_all_strings + 305)
#define SETTING_ETHERNET_SUBNET    (idigi_remote_all_strings + 308)
#define SETTING_ETHERNET_GATEWAY    (idigi_remote_all_strings + 315)
#define SETTING_ETHERNET_DHCP    (idigi_remote_all_strings + 323)
#define SETTING_ETHERNET_DNS    (idigi_remote_all_strings + 328)
#define SETTING_ETHERNET_DUPLEX    (idigi_remote_all_strings + 332)
#define SETTING_ETHERNET_DUPLEX_AUTO    (idigi_remote_all_strings + 339)
#define SETTING_ETHERNET_DUPLEX_HALF    (idigi_remote_all_strings + 344)
#define SETTING_ETHERNET_DUPLEX_FULL    (idigi_remote_all_strings + 349)
#define SETTING_ETHERNET_ERROR_INVALID_DUPLEX    (idigi_remote_all_strings + 354)
#define SETTING_ETHERNET_ERROR_INVALID_IP    (idigi_remote_all_strings + 369)
#define SETTING_ETHERNET_ERROR_INVALID_SUBNET    (idigi_remote_all_strings + 380)
#define SETTING_ETHERNET_ERROR_INVALID_GATEWAY    (idigi_remote_all_strings + 395)
#define SETTING_ETHERNET_ERROR_INVALID_DNS    (idigi_remote_all_strings + 411)
#define SETTING_DEVICE_STATS    (idigi_remote_all_strings + 423)
#define SETTING_DEVICE_STATS_CURTIME    (idigi_remote_all_strings + 436)
#define SETTING_DEVICE_STATS_CTEMP    (idigi_remote_all_strings + 444)
#define SETTING_DEVICE_STATS_FTEMP    (idigi_remote_all_strings + 450)
#define SETTING_DEVICE_INFO    (idigi_remote_all_strings + 456)
#define SETTING_DEVICE_INFO_PRODUCT    (idigi_remote_all_strings + 468)
#define SETTING_DEVICE_INFO_MODEL    (idigi_remote_all_strings + 476)
#define SETTING_DEVICE_INFO_COMPANY    (idigi_remote_all_strings + 482)
#define SETTING_DEVICE_INFO_DESC    (idigi_remote_all_strings + 490)
#define SETTING_DEVICE_INFO_SYSPWD    (idigi_remote_all_strings + 495)
#define SETTING_DEVICE_INFO_ERROR_INVALID_LENGTH    (idigi_remote_all_strings + 502)
#define STATE_DEBUG_INFO    (idigi_remote_all_strings + 517)
#define STATE_DEBUG_INFO_VERSION    (idigi_remote_all_strings + 528)
#define STATE_DEBUG_INFO_STACKTOP    (idigi_remote_all_strings + 536)
#define STATE_DEBUG_INFO_STACKSIZE    (idigi_remote_all_strings + 545)
#define STATE_DEBUG_INFO_STACKBOTTOM    (idigi_remote_all_strings + 555)
#define STATE_DEBUG_INFO_USEDMEM    (idigi_remote_all_strings + 567)
#define IDIGI_RCI_ERROR_PARSER_ERROR    (idigi_remote_all_strings + 575)
#define IDIGI_RCI_ERROR_BAD_XML    (idigi_remote_all_strings + 588)
#define IDIGI_RCI_ERROR_BAD_COMMAND    (idigi_remote_all_strings + 596)
#define IDIGI_RCI_ERROR_INVALID_VERSION    (idigi_remote_all_strings + 608)
#define IDIGI_RCI_ERROR_BAD_GROUP    (idigi_remote_all_strings + 624)
#define IDIGI_RCI_ERROR_BAD_INDEX    (idigi_remote_all_strings + 634)
#define IDIGI_RCI_ERROR_BAD_ELEMENT    (idigi_remote_all_strings + 644)
#define IDIGI_RCI_ERROR_BAD_VALUE    (idigi_remote_all_strings + 656)
#define IDIGI_GLOBAL_ERROR_LOAD_FAIL    (idigi_remote_all_strings + 666)
#define IDIGI_GLOBAL_ERROR_SAVE_FAIL    (idigi_remote_all_strings + 676)
#define IDIGI_GLOBAL_ERROR_MEMORY_FAIL    (idigi_remote_all_strings + 686)
