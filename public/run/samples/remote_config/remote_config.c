...
#define STATE_DEBUG_INFO    (idigi_remote_all_strings + 0)
#define STATE_DEBUG_INFO_VERSION    (idigi_remote_all_strings + 11)
#define STATE_DEBUG_INFO_STACKTOP    (idigi_remote_all_strings + 19)
#define STATE_DEBUG_INFO_STACKSIZE    (idigi_remote_all_strings + 28)
#define STATE_DEBUG_INFO_STACKBOTTOM    (idigi_remote_all_strings + 38)
#define STATE_DEBUG_INFO_USEDMEM    (idigi_remote_all_strings + 50)
#define SETTING_SERIAL    (idigi_remote_all_strings + 58)
#define SETTING_SERIAL_BAUD    (idigi_remote_all_strings + 65)
#define SETTING_SERIAL_BAUD_2400    (idigi_remote_all_strings + 70)
#define SETTING_SERIAL_BAUD_4800    (idigi_remote_all_strings + 75)
#define SETTING_SERIAL_BAUD_9600    (idigi_remote_all_strings + 80)
#define SETTING_SERIAL_BAUD_19200    (idigi_remote_all_strings + 85)
#define SETTING_SERIAL_BAUD_38400    (idigi_remote_all_strings + 91)
#define SETTING_SERIAL_BAUD_57600    (idigi_remote_all_strings + 97)
#define SETTING_SERIAL_BAUD_115200    (idigi_remote_all_strings + 103)
#define SETTING_SERIAL_BAUD_230400    (idigi_remote_all_strings + 110)
#define SETTING_SERIAL_PARITY    (idigi_remote_all_strings + 117)
#define SETTING_SERIAL_PARITY_NONE    (idigi_remote_all_strings + 124)
#define SETTING_SERIAL_PARITY_ODD    (idigi_remote_all_strings + 129)
#define SETTING_SERIAL_PARITY_EVEN    (idigi_remote_all_strings + 133)
#define SETTING_SERIAL_DATABITS    (idigi_remote_all_strings + 138)
#define SETTING_SERIAL_XBREAK    (idigi_remote_all_strings + 147)
#define SETTING_SERIAL_TXBYTES    (idigi_remote_all_strings + 154)
#define SETTING_SERIAL_ERROR_INVALID_BAUD    (idigi_remote_all_strings + 162)
#define SETTING_SERIAL_ERROR_INVALID_DATABITS    (idigi_remote_all_strings + 175)
#define SETTING_SERIAL_ERROR_INVALID_PARITY    (idigi_remote_all_strings + 192)
#define SETTING_SERIAL_ERROR_INVALID_XBREAK    (idigi_remote_all_strings + 207)
#define SETTING_SERIAL_ERROR_INVALID_DATABITS_PARITY    (idigi_remote_all_strings + 222)
#define SETTING_ETHERNET    (idigi_remote_all_strings + 246)
#define SETTING_ETHERNET_IP    (idigi_remote_all_strings + 255)
#define SETTING_ETHERNET_SUBNET    (idigi_remote_all_strings + 258)
#define SETTING_ETHERNET_GATEWAY    (idigi_remote_all_strings + 265)
#define SETTING_ETHERNET_DHCP    (idigi_remote_all_strings + 273)
#define SETTING_ETHERNET_DNS    (idigi_remote_all_strings + 278)
#define SETTING_ETHERNET_DUPLEX    (idigi_remote_all_strings + 282)
#define SETTING_ETHERNET_DUPLEX_AUTO    (idigi_remote_all_strings + 289)
#define SETTING_ETHERNET_DUPLEX_HALF    (idigi_remote_all_strings + 294)
#define SETTING_ETHERNET_DUPLEX_FULL    (idigi_remote_all_strings + 299)
#define SETTING_ETHERNET_ERROR_INVALID_DUPLEX    (idigi_remote_all_strings + 304)
#define SETTING_ETHERNET_ERROR_INVALID_IP    (idigi_remote_all_strings + 319)
#define SETTING_ETHERNET_ERROR_INVALID_SUBNET    (idigi_remote_all_strings + 330)
#define SETTING_ETHERNET_ERROR_INVALID_GATEWAY    (idigi_remote_all_strings + 345)
#define SETTING_ETHERNET_ERROR_INVALID_DNS    (idigi_remote_all_strings + 361)
#define SETTING_DEVICE_STATS    (idigi_remote_all_strings + 373)
#define SETTING_DEVICE_STATS_CURTIME    (idigi_remote_all_strings + 386)
#define SETTING_DEVICE_STATS_CTEMP    (idigi_remote_all_strings + 394)
#define SETTING_DEVICE_STATS_FTEMP    (idigi_remote_all_strings + 400)
#define SETTING_DEVICE_INFO    (idigi_remote_all_strings + 406)
#define SETTING_DEVICE_INFO_PRODUCT    (idigi_remote_all_strings + 418)
#define SETTING_DEVICE_INFO_MODEL    (idigi_remote_all_strings + 426)
#define SETTING_DEVICE_INFO_COMPANY    (idigi_remote_all_strings + 432)
#define SETTING_DEVICE_INFO_DESC    (idigi_remote_all_strings + 440)
#define SETTING_DEVICE_INFO_SYSPWD    (idigi_remote_all_strings + 445)
#define SETTING_DEVICE_INFO_ERROR_INVALID_LENGTH    (idigi_remote_all_strings + 452)
...
#define IDIGI_RCI_ERROR_INVALID_VERSION    (idigi_remote_all_strings + 488)
#define IDIGI_RCI_ERROR_BAD_GROUP    (idigi_remote_all_strings + 504)
#define IDIGI_RCI_ERROR_BAD_INDEX    (idigi_remote_all_strings + 514)
#define IDIGI_RCI_ERROR_BAD_ELEMENT    (idigi_remote_all_strings + 524)
#define IDIGI_RCI_ERROR_BAD_VALUE    (idigi_remote_all_strings + 536)
#define IDIGI_GLOBAL_ERROR_LOAD_FAIL    (idigi_remote_all_strings + 546)
#define IDIGI_GLOBAL_ERROR_SAVE_FAIL    (idigi_remote_all_strings + 556)
#define IDIGI_GLOBAL_ERROR_MEMORY_FAIL    (idigi_remote_all_strings + 566)
...
static char const * const state_debug_info_errors[] = {
...
static char const * const setting_device_stats_errors[] = {
    IDIGI_RCI_ERROR_PARSER_ERROR, /*parser_error*/
    IDIGI_RCI_ERROR_BAD_XML, /*bad_xml*/
    IDIGI_RCI_ERROR_BAD_ELEMENT, /*bad_element*/
    IDIGI_RCI_ERROR_BAD_VALUE, /*bad_value*/
...
idigi_group_t const idigi_remote_groups[] = {
    {    STATE_DEBUG_INFO,  /*debug_info*/
        ...
        {    asizeof(state_debug_info_errors),
            &state_debug_info_errors[0]
        }
    },
    ...
    {    SETTING_DEVICE_STATS,  /*device_stats*/
        ...
        {    asizeof(setting_device_stats_errors),
            &setting_device_stats_errors[0]
        }
    },
...
size_t const idigi_remote_group_count = asizeof(idigi_remote_groups);