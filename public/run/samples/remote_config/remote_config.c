 ...
 * This file was generated on: 2012/04/30 17:01:42 
...
#define SETTING_GPS (idigi_remote_all_strings+552)
#define SETTING_GPS_STATE (idigi_remote_all_strings+556)
#define SETTING_GPS_LATITUDE (idigi_remote_all_strings+562)
#define SETTING_GPS_LONGITUDE (idigi_remote_all_strings+571)
#define SETTING_GPS_ERROR_INVALID_LAT (idigi_remote_all_strings+581)
#define SETTING_GPS_ERROR_INVALID_LONG (idigi_remote_all_strings+593)
#define STATE_DEBUG_INFO (idigi_remote_all_strings+606)
#define STATE_DEBUG_INFO_VERSION (idigi_remote_all_strings+617)
#define STATE_DEBUG_INFO_STACKTOP (idigi_remote_all_strings+625)
#define STATE_DEBUG_INFO_STACKSIZE (idigi_remote_all_strings+634)
#define STATE_DEBUG_INFO_STACKBOTTOM (idigi_remote_all_strings+644)
#define STATE_DEBUG_INFO_USEDMEM (idigi_remote_all_strings+656)
...
static idigi_element_value_float_t const setting_gps_latitude_limit = {
 -90.0,
 90.0
};

static idigi_element_value_float_t const setting_gps_longitude_limit = {
 -180.0,
 180.0
};

static idigi_group_element_t const setting_gps_elements[] = {
 { SETTING_GPS_STATE,  /*state*/
   idigi_element_access_read_write,
   idigi_element_type_on_off,
  NULL
 },
 { SETTING_GPS_LATITUDE,  /*latitude*/
   idigi_element_access_read_write,
   idigi_element_type_float,
  (idigi_element_value_limit_t *)&setting_gps_latitude_limit
 },
 { SETTING_GPS_LONGITUDE,  /*longitude*/
   idigi_element_access_read_write,
   idigi_element_type_float,
  (idigi_element_value_limit_t *)&setting_gps_longitude_limit
 }
};

static char const * const setting_gps_errors[] = {
 SETTING_GPS_ERROR_INVALID_LAT, /*invalid_lat*/
 SETTING_GPS_ERROR_INVALID_LONG /*invalid_long*/
};
...
,
 { SETTING_GPS,  /*gps*/
   1,
   { asizeof(setting_gps_elements),
     setting_gps_elements
   },
   { asizeof(setting_gps_errors),
     setting_gps_errors
   }
 }
