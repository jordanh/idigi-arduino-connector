 ...
 * This file was generated on: 2012/04/12 16:41:32 
...
#define SETTING_SERIAL    (idigi_remote_all_strings + 104)
#define SETTING_SERIAL_BAUD    (idigi_remote_all_strings + 111)
#define SETTING_SERIAL_BAUD_2400    (idigi_remote_all_strings + 116)
#define SETTING_SERIAL_BAUD_4800    (idigi_remote_all_strings + 121)
#define SETTING_SERIAL_BAUD_9600    (idigi_remote_all_strings + 126)
#define SETTING_SERIAL_BAUD_19200    (idigi_remote_all_strings + 131)
#define SETTING_SERIAL_BAUD_38400    (idigi_remote_all_strings + 137)
#define SETTING_SERIAL_BAUD_57600    (idigi_remote_all_strings + 143)
#define SETTING_SERIAL_BAUD_115200    (idigi_remote_all_strings + 149)
#define SETTING_SERIAL_BAUD_230400    (idigi_remote_all_strings + 156)
#define SETTING_SERIAL_PARITY    (idigi_remote_all_strings + 163)
#define SETTING_SERIAL_PARITY_NONE    (idigi_remote_all_strings + 170)
#define SETTING_SERIAL_PARITY_ODD    (idigi_remote_all_strings + 175)
#define SETTING_SERIAL_PARITY_EVEN    (idigi_remote_all_strings + 179)
#define SETTING_SERIAL_DATABITS    (idigi_remote_all_strings + 184)
#define SETTING_SERIAL_XBREAK    (idigi_remote_all_strings + 193)
#define SETTING_SERIAL_TXBYTES    (idigi_remote_all_strings + 200)
#define SETTING_SERIAL_ERROR_INVALID_BAUD    (idigi_remote_all_strings + 208)
#define SETTING_SERIAL_ERROR_INVALID_DATABITS    (idigi_remote_all_strings + 221)
#define SETTING_SERIAL_ERROR_INVALID_PARITY    (idigi_remote_all_strings + 238)
#define SETTING_SERIAL_ERROR_INVALID_XBREAK    (idigi_remote_all_strings + 253)
#define SETTING_SERIAL_ERROR_INVALID_DATABITS_PARITY    (idigi_remote_all_strings + 268)
#define SETTING_ETHERNET    (idigi_remote_all_strings + 292)
#define SETTING_ETHERNET_IP    (idigi_remote_all_strings + 301)
#define SETTING_ETHERNET_SUBNET    (idigi_remote_all_strings + 304)
#define SETTING_ETHERNET_GATEWAY    (idigi_remote_all_strings + 311)
#define SETTING_ETHERNET_DHCP    (idigi_remote_all_strings + 319)
#define SETTING_ETHERNET_DNS    (idigi_remote_all_strings + 324)
#define SETTING_ETHERNET_DUPLEX    (idigi_remote_all_strings + 328)
#define SETTING_ETHERNET_DUPLEX_AUTO    (idigi_remote_all_strings + 335)
#define SETTING_ETHERNET_DUPLEX_HALF    (idigi_remote_all_strings + 340)
#define SETTING_ETHERNET_DUPLEX_FULL    (idigi_remote_all_strings + 345)
#define SETTING_ETHERNET_ERROR_INVALID_DUPLEX    (idigi_remote_all_strings + 350)
#define SETTING_ETHERNET_ERROR_INVALID_IP    (idigi_remote_all_strings + 365)
#define SETTING_ETHERNET_ERROR_INVALID_SUBNET    (idigi_remote_all_strings + 376)
#define SETTING_ETHERNET_ERROR_INVALID_GATEWAY    (idigi_remote_all_strings + 391)
#define SETTING_ETHERNET_ERROR_INVALID_DNS    (idigi_remote_all_strings + 407)
#define SETTING_DEVICE_STATS    (idigi_remote_all_strings + 419)
#define SETTING_DEVICE_STATS_CURTIME    (idigi_remote_all_strings + 432)
#define SETTING_DEVICE_STATS_CTEMP    (idigi_remote_all_strings + 440)
#define SETTING_DEVICE_STATS_FTEMP    (idigi_remote_all_strings + 446)
#define SETTING_DEVICE_INFO    (idigi_remote_all_strings + 452)
#define SETTING_DEVICE_INFO_PRODUCT    (idigi_remote_all_strings + 464)
#define SETTING_DEVICE_INFO_MODEL    (idigi_remote_all_strings + 472)
#define SETTING_DEVICE_INFO_COMPANY    (idigi_remote_all_strings + 478)
#define SETTING_DEVICE_INFO_DESC    (idigi_remote_all_strings + 486)
#define SETTING_DEVICE_INFO_SYSPWD    (idigi_remote_all_strings + 491)
#define SETTING_DEVICE_INFO_ERROR_INVALID_LENGTH    (idigi_remote_all_strings + 498)
#define STATE_DEBUG_INFO    (idigi_remote_all_strings + 513)
#define STATE_DEBUG_INFO_VERSION    (idigi_remote_all_strings + 524)
#define STATE_DEBUG_INFO_STACKTOP    (idigi_remote_all_strings + 532)
#define STATE_DEBUG_INFO_STACKSIZE    (idigi_remote_all_strings + 541)
#define STATE_DEBUG_INFO_STACKBOTTOM    (idigi_remote_all_strings + 551)
#define STATE_DEBUG_INFO_USEDMEM    (idigi_remote_all_strings + 563)
#define IDIGI_RCI_ERROR_PARSER_ERROR    (idigi_remote_all_strings + 571)
#define IDIGI_RCI_ERROR_BAD_XML    (idigi_remote_all_strings + 584)
#define IDIGI_RCI_ERROR_BAD_COMMAND    (idigi_remote_all_strings + 592)
#define IDIGI_RCI_ERROR_INVALID_VERSION    (idigi_remote_all_strings + 604)
#define IDIGI_RCI_ERROR_BAD_GROUP    (idigi_remote_all_strings + 620)
#define IDIGI_RCI_ERROR_BAD_INDEX    (idigi_remote_all_strings + 630)
#define IDIGI_RCI_ERROR_BAD_ELEMENT    (idigi_remote_all_strings + 640)
#define IDIGI_RCI_ERROR_BAD_VALUE    (idigi_remote_all_strings + 652)
#define IDIGI_GLOBAL_ERROR_LOAD_FAIL    (idigi_remote_all_strings + 662)
#define IDIGI_GLOBAL_ERROR_SAVE_FAIL    (idigi_remote_all_strings + 672)
#define IDIGI_GLOBAL_ERROR_MEMORY_FAIL    (idigi_remote_all_strings + 682)
