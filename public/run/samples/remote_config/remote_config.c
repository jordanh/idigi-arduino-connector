 ...
 * This file was generated on: 2012/04/12 10:54:27 
...
#define SETTING_SERIAL    (idigi_remote_all_strings + 82)
#define SETTING_SERIAL_BAUD    (idigi_remote_all_strings + 89)
#define SETTING_SERIAL_BAUD_2400    (idigi_remote_all_strings + 94)
#define SETTING_SERIAL_BAUD_4800    (idigi_remote_all_strings + 99)
#define SETTING_SERIAL_BAUD_9600    (idigi_remote_all_strings + 104)
#define SETTING_SERIAL_BAUD_19200    (idigi_remote_all_strings + 109)
#define SETTING_SERIAL_BAUD_38400    (idigi_remote_all_strings + 115)
#define SETTING_SERIAL_BAUD_57600    (idigi_remote_all_strings + 121)
#define SETTING_SERIAL_BAUD_115200    (idigi_remote_all_strings + 127)
#define SETTING_SERIAL_BAUD_230400    (idigi_remote_all_strings + 134)
#define SETTING_SERIAL_PARITY    (idigi_remote_all_strings + 141)
#define SETTING_SERIAL_PARITY_NONE    (idigi_remote_all_strings + 148)
#define SETTING_SERIAL_PARITY_ODD    (idigi_remote_all_strings + 153)
#define SETTING_SERIAL_PARITY_EVEN    (idigi_remote_all_strings + 157)
#define SETTING_SERIAL_DATABITS    (idigi_remote_all_strings + 162)
#define SETTING_SERIAL_XBREAK    (idigi_remote_all_strings + 171)
#define SETTING_SERIAL_TXBYTES    (idigi_remote_all_strings + 178)
#define SETTING_SERIAL_ERROR_INVALID_BAUD    (idigi_remote_all_strings + 186)
#define SETTING_SERIAL_ERROR_INVALID_DATABITS    (idigi_remote_all_strings + 199)
#define SETTING_SERIAL_ERROR_INVALID_PARITY    (idigi_remote_all_strings + 216)
#define SETTING_SERIAL_ERROR_INVALID_XBREAK    (idigi_remote_all_strings + 231)
#define SETTING_SERIAL_ERROR_INVALID_DATABITS_PARITY    (idigi_remote_all_strings + 246)
#define SETTING_ETHERNET    (idigi_remote_all_strings + 270)
#define SETTING_ETHERNET_IP    (idigi_remote_all_strings + 279)
#define SETTING_ETHERNET_SUBNET    (idigi_remote_all_strings + 282)
#define SETTING_ETHERNET_GATEWAY    (idigi_remote_all_strings + 289)
#define SETTING_ETHERNET_DHCP    (idigi_remote_all_strings + 297)
#define SETTING_ETHERNET_DNS    (idigi_remote_all_strings + 302)
#define SETTING_ETHERNET_DUPLEX    (idigi_remote_all_strings + 306)
#define SETTING_ETHERNET_DUPLEX_AUTO    (idigi_remote_all_strings + 313)
#define SETTING_ETHERNET_DUPLEX_HALF    (idigi_remote_all_strings + 318)
#define SETTING_ETHERNET_DUPLEX_FULL    (idigi_remote_all_strings + 323)
#define SETTING_ETHERNET_ERROR_INVALID_DUPLEX    (idigi_remote_all_strings + 328)
#define SETTING_ETHERNET_ERROR_INVALID_IP    (idigi_remote_all_strings + 343)
#define SETTING_ETHERNET_ERROR_INVALID_SUBNET    (idigi_remote_all_strings + 354)
#define SETTING_ETHERNET_ERROR_INVALID_GATEWAY    (idigi_remote_all_strings + 369)
#define SETTING_ETHERNET_ERROR_INVALID_DNS    (idigi_remote_all_strings + 385)
#define SETTING_DEVICE_STATS    (idigi_remote_all_strings + 397)
#define SETTING_DEVICE_STATS_CURTIME    (idigi_remote_all_strings + 410)
#define SETTING_DEVICE_STATS_CTEMP    (idigi_remote_all_strings + 418)
#define SETTING_DEVICE_STATS_FTEMP    (idigi_remote_all_strings + 424)
#define SETTING_DEVICE_INFO    (idigi_remote_all_strings + 430)
#define SETTING_DEVICE_INFO_PRODUCT    (idigi_remote_all_strings + 442)
#define SETTING_DEVICE_INFO_MODEL    (idigi_remote_all_strings + 450)
#define SETTING_DEVICE_INFO_COMPANY    (idigi_remote_all_strings + 456)
#define SETTING_DEVICE_INFO_DESC    (idigi_remote_all_strings + 464)
#define SETTING_DEVICE_INFO_SYSPWD    (idigi_remote_all_strings + 469)
#define SETTING_DEVICE_INFO_ERROR_INVALID_LENGTH    (idigi_remote_all_strings + 476)
#define STATE_DEBUG_INFO    (idigi_remote_all_strings + 491)
#define STATE_DEBUG_INFO_VERSION    (idigi_remote_all_strings + 502)
#define STATE_DEBUG_INFO_STACKTOP    (idigi_remote_all_strings + 510)
#define STATE_DEBUG_INFO_STACKSIZE    (idigi_remote_all_strings + 519)
#define STATE_DEBUG_INFO_STACKBOTTOM    (idigi_remote_all_strings + 529)
#define STATE_DEBUG_INFO_USEDMEM    (idigi_remote_all_strings + 541)
#define IDIGI_RCI_ERROR_PARSER_ERROR    (idigi_remote_all_strings + 549)
#define IDIGI_RCI_ERROR_BAD_XML    (idigi_remote_all_strings + 562)
#define IDIGI_RCI_ERROR_BAD_COMMAND    (idigi_remote_all_strings + 570)
#define IDIGI_RCI_ERROR_INVALID_VERSION    (idigi_remote_all_strings + 582)
#define IDIGI_RCI_ERROR_BAD_GROUP    (idigi_remote_all_strings + 598)
#define IDIGI_RCI_ERROR_BAD_INDEX    (idigi_remote_all_strings + 608)
#define IDIGI_RCI_ERROR_BAD_ELEMENT    (idigi_remote_all_strings + 618)
#define IDIGI_RCI_ERROR_BAD_VALUE    (idigi_remote_all_strings + 630)
#define IDIGI_GLOBAL_ERROR_LOAD_FAIL    (idigi_remote_all_strings + 640)
#define IDIGI_GLOBAL_ERROR_SAVE_FAIL    (idigi_remote_all_strings + 650)
#define IDIGI_GLOBAL_ERROR_MEMORY_FAIL    (idigi_remote_all_strings + 660)
