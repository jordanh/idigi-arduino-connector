 ...
 * This is generated by Class tool 
 * This file was generated on: 2012/04/25 18:21:01 
 * The command line arguments were: "-s=test.idigi.com mlchan:***** "Simple Remote Config Linux Application" 1 config.rci" 
 * The version of Class tool was: 1.0.0.0
*/
...
#define SETTING_DEVICE_STATS_CTEMP (idigi_remote_all_strings+476)
#define SETTING_DEVICE_STATS_FTEMP (idigi_remote_all_strings+482)
#define SETTING_DEVICE_INFO (idigi_remote_all_strings+488)
#define SETTING_DEVICE_INFO_PRODUCT (idigi_remote_all_strings+500)
#define SETTING_DEVICE_INFO_MODEL (idigi_remote_all_strings+508)
#define SETTING_DEVICE_INFO_COMPANY (idigi_remote_all_strings+514)
#define SETTING_DEVICE_INFO_DESC (idigi_remote_all_strings+522)
#define SETTING_DEVICE_INFO_SYSPWD (idigi_remote_all_strings+527)
#define SETTING_DEVICE_INFO_ERROR_INVALID_LENGTH (idigi_remote_all_strings+534)
#define STATE_DEBUG_INFO (idigi_remote_all_strings+549)
#define STATE_DEBUG_INFO_VERSION (idigi_remote_all_strings+560)
#define STATE_DEBUG_INFO_STACKTOP (idigi_remote_all_strings+568)
#define STATE_DEBUG_INFO_STACKSIZE (idigi_remote_all_strings+577)
#define STATE_DEBUG_INFO_STACKBOTTOM (idigi_remote_all_strings+587)
#define STATE_DEBUG_INFO_USEDMEM (idigi_remote_all_strings+599)
#define IDIGI_RCI_ERROR_PARSER_ERROR (idigi_remote_all_strings+607)
#define IDIGI_RCI_ERROR_BAD_XML (idigi_remote_all_strings+620)
#define IDIGI_RCI_ERROR_BAD_COMMAND (idigi_remote_all_strings+628)
#define IDIGI_RCI_ERROR_INVALID_VERSION (idigi_remote_all_strings+640)
#define IDIGI_RCI_ERROR_BAD_GROUP (idigi_remote_all_strings+656)
#define IDIGI_RCI_ERROR_BAD_INDEX (idigi_remote_all_strings+666)
#define IDIGI_RCI_ERROR_BAD_ELEMENT (idigi_remote_all_strings+676)
#define IDIGI_RCI_ERROR_BAD_VALUE (idigi_remote_all_strings+688)
#define IDIGI_GLOBAL_ERROR_LOAD_FAIL (idigi_remote_all_strings+698)
#define IDIGI_GLOBAL_ERROR_SAVE_FAIL (idigi_remote_all_strings+708)
#define IDIGI_GLOBAL_ERROR_MEMORY_FAIL (idigi_remote_all_strings+718)
