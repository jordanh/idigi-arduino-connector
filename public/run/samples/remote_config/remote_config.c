 ...
 * This file was generated on: 2012/04/23 10:26:55 
...
#define SETTING_SERIAL    (idigi_remote_all_strings + 122)
#define SETTING_SERIAL_BAUD    (idigi_remote_all_strings + 129)
#define SETTING_SERIAL_BAUD_2400    (idigi_remote_all_strings + 134)
#define SETTING_SERIAL_BAUD_4800    (idigi_remote_all_strings + 139)
#define SETTING_SERIAL_BAUD_9600    (idigi_remote_all_strings + 144)
#define SETTING_SERIAL_BAUD_19200    (idigi_remote_all_strings + 149)
#define SETTING_SERIAL_BAUD_38400    (idigi_remote_all_strings + 155)
#define SETTING_SERIAL_BAUD_57600    (idigi_remote_all_strings + 161)
#define SETTING_SERIAL_BAUD_115200    (idigi_remote_all_strings + 167)
#define SETTING_SERIAL_BAUD_230400    (idigi_remote_all_strings + 174)
#define SETTING_SERIAL_PARITY    (idigi_remote_all_strings + 181)
#define SETTING_SERIAL_PARITY_NONE    (idigi_remote_all_strings + 188)
#define SETTING_SERIAL_PARITY_ODD    (idigi_remote_all_strings + 193)
#define SETTING_SERIAL_PARITY_EVEN    (idigi_remote_all_strings + 197)
#define SETTING_SERIAL_DATABITS    (idigi_remote_all_strings + 202)
#define SETTING_SERIAL_XBREAK    (idigi_remote_all_strings + 211)
#define SETTING_SERIAL_TXBYTES    (idigi_remote_all_strings + 218)
#define SETTING_SERIAL_ERROR_INVALID_BAUD    (idigi_remote_all_strings + 226)
#define SETTING_SERIAL_ERROR_INVALID_DATABITS    (idigi_remote_all_strings + 239)
#define SETTING_SERIAL_ERROR_INVALID_PARITY    (idigi_remote_all_strings + 256)
#define SETTING_SERIAL_ERROR_INVALID_XBREAK    (idigi_remote_all_strings + 271)
#define SETTING_SERIAL_ERROR_INVALID_DATABITS_PARITY    (idigi_remote_all_strings + 286)
#define SETTING_ETHERNET    (idigi_remote_all_strings + 310)
#define SETTING_ETHERNET_IP    (idigi_remote_all_strings + 319)
#define SETTING_ETHERNET_SUBNET    (idigi_remote_all_strings + 322)
#define SETTING_ETHERNET_GATEWAY    (idigi_remote_all_strings + 329)
#define SETTING_ETHERNET_DHCP    (idigi_remote_all_strings + 337)
#define SETTING_ETHERNET_DNS    (idigi_remote_all_strings + 342)
#define SETTING_ETHERNET_DUPLEX    (idigi_remote_all_strings + 346)
#define SETTING_ETHERNET_DUPLEX_AUTO    (idigi_remote_all_strings + 353)
#define SETTING_ETHERNET_DUPLEX_HALF    (idigi_remote_all_strings + 358)
#define SETTING_ETHERNET_DUPLEX_FULL    (idigi_remote_all_strings + 363)
#define SETTING_ETHERNET_ERROR_INVALID_DUPLEX    (idigi_remote_all_strings + 368)
#define SETTING_ETHERNET_ERROR_INVALID_IP    (idigi_remote_all_strings + 383)
#define SETTING_ETHERNET_ERROR_INVALID_SUBNET    (idigi_remote_all_strings + 394)
#define SETTING_ETHERNET_ERROR_INVALID_GATEWAY    (idigi_remote_all_strings + 409)
#define SETTING_ETHERNET_ERROR_INVALID_DNS    (idigi_remote_all_strings + 425)
#define SETTING_DEVICE_STATS    (idigi_remote_all_strings + 437)
#define SETTING_DEVICE_STATS_CURTIME    (idigi_remote_all_strings + 450)
#define SETTING_DEVICE_STATS_CTEMP    (idigi_remote_all_strings + 458)
#define SETTING_DEVICE_STATS_FTEMP    (idigi_remote_all_strings + 464)
#define SETTING_DEVICE_INFO    (idigi_remote_all_strings + 470)
#define SETTING_DEVICE_INFO_PRODUCT    (idigi_remote_all_strings + 482)
#define SETTING_DEVICE_INFO_MODEL    (idigi_remote_all_strings + 490)
#define SETTING_DEVICE_INFO_COMPANY    (idigi_remote_all_strings + 496)
#define SETTING_DEVICE_INFO_DESC    (idigi_remote_all_strings + 504)
#define SETTING_DEVICE_INFO_SYSPWD    (idigi_remote_all_strings + 509)
#define SETTING_DEVICE_INFO_ERROR_INVALID_LENGTH    (idigi_remote_all_strings + 516)
#define STATE_DEBUG_INFO    (idigi_remote_all_strings + 531)
#define STATE_DEBUG_INFO_VERSION    (idigi_remote_all_strings + 542)
#define STATE_DEBUG_INFO_STACKTOP    (idigi_remote_all_strings + 550)
#define STATE_DEBUG_INFO_STACKSIZE    (idigi_remote_all_strings + 559)
#define STATE_DEBUG_INFO_STACKBOTTOM    (idigi_remote_all_strings + 569)
#define STATE_DEBUG_INFO_USEDMEM    (idigi_remote_all_strings + 581)
#define IDIGI_RCI_ERROR_PARSER_ERROR    (idigi_remote_all_strings + 589)
#define IDIGI_RCI_ERROR_BAD_XML    (idigi_remote_all_strings + 602)
#define IDIGI_RCI_ERROR_BAD_COMMAND    (idigi_remote_all_strings + 610)
#define IDIGI_RCI_ERROR_INVALID_VERSION    (idigi_remote_all_strings + 622)
#define IDIGI_RCI_ERROR_BAD_GROUP    (idigi_remote_all_strings + 638)
#define IDIGI_RCI_ERROR_BAD_INDEX    (idigi_remote_all_strings + 648)
#define IDIGI_RCI_ERROR_BAD_ELEMENT    (idigi_remote_all_strings + 658)
#define IDIGI_RCI_ERROR_BAD_VALUE    (idigi_remote_all_strings + 670)
#define IDIGI_GLOBAL_ERROR_LOAD_FAIL    (idigi_remote_all_strings + 680)
#define IDIGI_GLOBAL_ERROR_SAVE_FAIL    (idigi_remote_all_strings + 690)
#define IDIGI_GLOBAL_ERROR_MEMORY_FAIL    (idigi_remote_all_strings + 700)
